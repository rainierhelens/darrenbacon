...
export const deadropArtDirection = {
  ...
  thesis: {
    title: 'Neon-noir towers you can still read in a fight',
    body: 'DEADROP had to feel like an 80s-that-never-ended extraction fantasy and still play like a competitive shooter. My job was to lock a Refiner State visual language (verticality, neon-noir contrast, industrial grime) and hold it across seven public Snapshots, three live-city reveals, and a studio art team built from scratch.',
  },
  directed: [
    'Defined the Maker Art Style Guide and the visual thesis for the Refiner States',
    'Stood up and led the studio art team plus external co-developers through open development',
    'Directed Snapshot art from firing ranges to Sector 3, Cleaners, and Midnight Ride',
    'Art-directed live reveals in Los Angeles, Dallas, and Las Vegas',
    'Captured and shaped the 2024 in-engine showcase trailer',
  ],
  /** Curated strip shown before the full Snapshot archive. */
  selectedWorks: [
    {
      src: DEADROP_COVER,
      caption: 'Refiner State world',
      type: 'image' as const,
    },
    {
      src: '/images/deadrop-ad/SSI/Skybox_PO3.jpg',
      caption: 'Skybox direction · Snapshot I',
      type: 'image' as const,
    },
    {
      src: '/images/deadrop-ad/SSI/ScreenShot00107-po_before-after.jpg',
      caption: 'Environment paintover · Snapshot I',
      type: 'image' as const,
    },
    {
      src: '/images/deadrop-ad/SSII/Render2.jpg',
      caption: 'Tower verticality · Snapshot II',
      type: 'image' as const,
    },
    {
      src: '/images/deadrop-ad/SSIII/Fender_Heavysuits_01.jpg',
      caption: 'Suit / character language · Snapshot III',
      type: 'image' as const,
    },
    {
      src: '/images/deadrop-ad/SSIV/AutoShotgun2500px_TPZ-enhance-sharpen.jpg',
      caption: 'Legendary weapon · Snapshot IV',
      type: 'image' as const,
    },
    {
      src: '/images/deadrop-ad/SSV/SHIPPING_paintover-1a.jpg',
      caption: 'Sector 3 paintover · Snapshot V',
      type: 'image' as const,
    },
    {
      src: '/images/deadrop-ad/SSVII/drive%20to%20tower/Gallus_DEADROP_mood.jpg',
      caption: 'Midnight Ride vehicle · Snapshot VII',
      type: 'image' as const,
    },
  ],
  intro: [
...
const snapshotDefinitions: SnapshotDefinition[] = [
    ...
    },
    {
      ...
      story: [
        ...
        'This is where art direction and design locked arms: every new verb needed predictable visual telegraphing, with hand holds, zip lines, and ledge silhouettes tuned so players could plan routes under pressure.',
      ],
      highlights: [
    ...
    },
    {
      ...
      highlights: [
        'Sector 3: Cold Storage, the first full tower sector',
...
Object.assign(deadropArtDirection, {
  ...
  finalTrailer: {
    ...
    paragraphs: [
      ...
      'Directing capture meant choosing angles that sold scale, freeze, and faction identity while staying honest to what players actually saw in-game. Showing the real thing and making it look inevitable was the through-line of Midnight Society\'s open development promise.',
    ],
